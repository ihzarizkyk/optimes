			...
			<div class="col-lg-12 col-sm-12">
				<div class="row align-items-center justify-content-center no-gutters">
					<div class="col-sm-6 mr-5">
						...
						<h2>Sign Up</h2>
						<p class="mb-5">Selamat datang, silahkan daftar terlebih dahulu</p>
						...
						@csrf
							...
							<div class="form-group mb-2">
								...
								<input type="text" name="email" class="form-control" placeholder="cth. john@gmail.com">
							</div>
							<div class="form-group mb-2">
							...
							<input type="submit" name="signIn" class="btn btn-primary mb-3" value="Daftar">
							<a href="/" class="btn btn-outline-danger mb-3">Kembali</a>
							<p class="text-secondary">Sudah punya akun? <a href="/auth/signin">Masuk</a></p>
						</form>
					</div>
